      ...
      <Header />
            ...
            <div className="bg-black  bg-opacity-50 w-full h-full flex items-center justify-start px-10 ">
              <div className="text-center text-white mt-[60px] px-2 sm:px-2 sm:mt-[130px]   lg:mt-[20px] sm:text-center lg:px-8 lg:text-start">
                ...
                <button className="mt-[80px]  px-4 py-2 bg-orange-500 hover:bg-orange-600 lg:py-4 font-semibold lg:px-8 text-white rounded-md">
                 LEARN MORE
                </button>
        ...
        {/* Indicators */}
      <div className="absolute   inset-0 flex items-center justify-center mb-[-95%]  sm:mb-[-95%] md:mb-[-60%] lg:mb-[-50%]">
